...
class SistemaCadastrosApp:
    ...
    def criar_interface(self):
        ...
        self.lbl_status_inicializacao.pack(anchor="e", pady=(6, 0))        
    ...
    def criar_campo_formulario(
        ...
        card.grid(row=linha, column=coluna, columnspan=columnspan, sticky="nsew", padx=5, pady=5)
        ...
        tk.Label(
            ...
            anchor="w",
            justify="left",
            wraplength=500 if columnspan > 1 else 210,
    ...
    def exibir_detalhes(self, cadastro, origem="pendente"):
        ...
        topo_ficha.pack(fill="x", pady=(0, 6))
        ...
        nome_linha.pack(fill="x", pady=(5, 0))
        ...
        tk.Label(
            card_digitacao,
            text="SmartCard" if origem == "pendente" else "SmartCard",
            bg=CORES["card_info"],
            fg=CORES["texto_secundario"],
            font=("Segoe UI", 8, "bold"),
            anchor="w",
        ...
        linha_smartcard.pack(fill="x", pady=(4, 0))
        ...
        self.entry_smartcard = tk.Entry(
            ...
            relief="solid",
            bd=1,
            readonlybackground=CORES["card_info_2"],  # 👈 COR CORRETA PARA READONLY
        )

        self.entry_smartcard.pack(side="left", fill="x", expand=True, ipady=5)
        ...
        if origem == "pendente":
            ...
            self.entry_smartcard.configure(
                state="readonly",
                fg=CORES["texto_secundario"],  # deixa mais "apagado"
            )
        ...
        linha_acoes.pack(fill="x", pady=(6, 6))
